...
(iii). **Dishes Section:**
   - In the dishes section, there are several boxes displaying popular dishes. Each box includes an image of the dish, icons for actions like "heart" and "eye," 
     the name of the dish, star ratings, price, and an "add to cart" button.
...
Our project is released under the [MIT License](https://opensource.org/licenses/MIT). Feel free to check the [LICENSE](#) file for more details.
